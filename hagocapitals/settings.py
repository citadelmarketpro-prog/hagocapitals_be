...
MIDDLEWARE = [
    ...
    "hagocapitals.middleware.AppendSlashMiddleware",
...
ROOT_URLCONF = "hagocapitals.urls"
...
WSGI_APPLICATION = "hagocapitals.wsgi.application"
APPEND_SLASH = False
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='HagoCapitals <support@hagocapitals.com>')
ADMIN_NOTIFICATION_EMAIL = config('ADMIN_NOTIFICATION_EMAIL', default='support@hagocapitals.com')
